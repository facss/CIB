...
###################################### 1.Data Loader#################################################
    ...
    VAE_train_loader=DataLoader(VAE_traindata,shuffle=True,num_workers=opts.num_workers,batch_size=opts.VAE_training_batch_size)
...
####################################### 3.Optimizer ################################################################
    ...
    VAEOptimizer=optim.Adam(VAEModel.parameters(),lr=opts.lr)# optimzer4vae 
    best_val=0   
    print('optimizer done.')
        
#################################################### 4.training#####################################################
    modelTrain=ModelTrain(opts,VAEModel,MLPModel,VAE_train_loader, MLP_train_loader,MLP_val_loader,
